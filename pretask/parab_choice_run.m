...
% code for summer school Sept 2025 
% Selma Lugtmeijer
...
cd % data path
savedir = % save in folder called 'results_pre/'

%% experiment information
prac_length = ; % how many practice trials?
NFT_length = ; % how many trials in the Not Fatigue Task (NFT) part of the experiment?
...
for j = 1:n
    try
        ...
        for i = 1:NFT_length
            ...
            choice_only_reward(i) = % ? to get levels of reward (2-6) instead of credits (2-10), rest is 1 is level 1
        ...
        % What do to when no response was given on a trial and why?
        % Add some code
        ...
        % Find subjects that always always work (1)
        % How often does each subject rest?
        n_rest(j) = %?
...
%% Visualise
% Plot some data to get insight in responses per trial across subjects 
% e.g.:
